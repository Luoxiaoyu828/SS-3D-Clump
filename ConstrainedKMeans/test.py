...
from src.ConstrainedKMeans import ConstrainedKMeans as CKM
...
def run_test():
    ...
    return x, init_labels, can_change


if __name__ == '__main__':
    x, init_labels, can_change = run_test()
    init_labels_ = init_labels.copy()
    ...
    ckm.fit(x, can_change, init_labels_)
